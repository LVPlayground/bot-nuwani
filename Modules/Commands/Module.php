        ...
        private function registerInternalCommands ()
        {
                $this -> registerCommand (new Command ('cmdadd',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                ...
                                {
                                        ModuleManager :: getInstance () -> offsetGet ('Commands')
                ...
                -> registerCommand (new Command ('cmdremove',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                ...
                                {
                                        if (!ModuleManager :: getInstance () -> offsetGet ('Commands') -> deleteCommand ($aParams [0]))
                ...
                -> registerCommand (new Command ('cmdrename',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                ...
                                {
                                        if (!ModuleManager :: getInstance () -> offsetGet ('Commands') -> renameCommand ($aParams [0], $aParams [1]))
                                                echo '4* Error: The command has not been found.';
                                        else
                ...
                -> registerCommand (new Command ('cmdchannel',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                ...
                                {
                                        $c = ModuleManager :: getInstance () -> offsetGet ('Commands') -> offsetGet ($aParams [0]);
                                        if ($c)
                                        {
                ...
                -> registerCommand (new Command ('cmdlist',
                        ...
                        {
                                $aCmd = array ();
                                foreach (ModuleManager :: getInstance () -> offsetGet ('Commands') -> getIterator () as $sName => $pCommand)
                                        $aCmd [] = $sName;

                                echo wordwrap ('10* Commands (' . count (ModuleManager :: getInstance () -> offsetGet ('Commands')) . '): ' . implode (', !', $aCmd), 400);
                        },
                        ISecurityProvider :: BOT_OWNER
                ))
                -> registerCommand (new Command ('moduleload',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                ...
                                {
                                        if (ModuleManager :: getInstance () -> loadModule ($aParams [0]))
                ...
                -> registerCommand (new Command ('moduleunload',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                ...
                                {
                                        if (ModuleManager :: getInstance () -> unloadModule ($aParams [0]))
                ...
                -> registerCommand (new Command ('modulereload',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                ...
                                {
                                        if (ModuleManager :: getInstance () -> reloadModule ($aParams [0]))
                ...
                -> registerCommand (new Command ('botlist',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                $c = BotManager :: getInstance () -> getBotList ();
                                $aBots = array ();
                ...
                -> registerCommand (new Command ('restart',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                BotManager :: getInstance () -> getBotList () -> send ('QUIT :Restart requested by ' . $sNickname);
                                usleep (150000);
                ...
                -> registerCommand (new Command ('cmdlevel',
                        function ($pBot, $sDestination, $sChannel, $sNickname, $aParams, $sMessage)
                        {
                                ...
                                {
                                        if (!ModuleManager :: getInstance () -> offsetGet ('Commands') -> setCommandLevel ($aParams [0], $aParams [1]))
                                                echo '4* Error: The command has not been found.';
                                        else
